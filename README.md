...
- **Mock tests**: for every section you now enter both *questions asked*
  and *score obtained*, and score fields accept 0.25 steps (0, 0.25, 0.5,
  0.75...) to match CLAT's +1 / -0.25 marking scheme.
...
- Line chart (score trend) and bar chart (section breakdown)
